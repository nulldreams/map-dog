...
// --------- AUTENTICACAO
    ...
    app.get('/mapa', (req, res) =>{
      ...
      res.json({ status: 200, result: req.user })
        //res.render('pages/mapa', { user: req.user })
    })  

    // route middleware to make sure a user is logged in
    var estaLogado = (req, res, next) => {
